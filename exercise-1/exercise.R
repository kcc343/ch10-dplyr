...
makes_1997 <- cars_1997[order(cars_1997$hwy), ]

# Mutate the 1997 cars data frame to add a column `average` that has the average
# gas milage (between city and highway mpg) for each car

makes_1997$average <- (makes_1997$cty + makes_1997$hwy) / 2
...
worst_hwy <- two_wheel_20_mpg[two_wheel_20_mpg$hwy == min(two_wheel_20_mpg$hwy),
                              "id"]
